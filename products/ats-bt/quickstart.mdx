...
<div style={{display: 'flex', gap: '10px', marginBottom: '10px'}}>
  <img src="/images/ats-bt-quickstart/ats-bt-front.jpg" alt="ATS-BT Front" style={{width: '95%', height: 'auto'}} />
  <img src="/images/ats-bt-quickstart/ats-bt-rear.jpg" alt="ATS-BT Rear" style={{width: '95%', height: 'auto'}} />
</div>

**Figure 1:**  **ATS-BT Module Front and Rear**

![ATS Right Rear](/images/ats-bt-quickstart/ats-right-rear.jpg)
...
![PuTTY Configuration](/images/ats-bt-quickstart/putty_config.png)
...
![Hercules Terminal](/images/ats-bt-quickstart/hercules_terminal.png)
