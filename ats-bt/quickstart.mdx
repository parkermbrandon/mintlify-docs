...
<div style={{display: 'flex', gap: '10px', marginBottom: '10px'}}>
  <img src="/images/ats-bt/ats-bt-front.jpg" alt="ATS-BT Front" style={{width: '49%', height: 'auto'}} />
  <img src="/images/ats-bt/ats-bt-rear.jpg" alt="ATS-BT Rear" style={{width: '49%', height: 'auto'}} />
</div>

**Figure 1:**  **ATS-BT Module Front and Rear**

![ATS Right Rear](/images/ats-bt/ats-right-rear.jpg)
